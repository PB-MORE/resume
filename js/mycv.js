...
$(function() {
    ...
    $(window).scroll(function () {
        ...
        var s = $(window).scrollTop();
        s > top1*0.6 ? $('#nav-bar').addClass("fixed show animated bounceInUp").removeClass("hide") : $('#nav-bar').removeClass("fixed show").addClass("hide");
...
$(".skill>p:first-child>img").mouseover(function () {
    $(this).addClass("zoomIn");
}).mouseout(function () {
    $(this).removeClass("zoomIn");
})
$("div.f1").mouseover(function () {
    console.log($(this));
